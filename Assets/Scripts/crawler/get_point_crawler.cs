...
public class get_point_crawler : MonoBehaviour
{
    public static get_point_crawler Instance;
    ...
    public Vector3 get_random_point_crawler(Transform point = null, float radius = 0)
    {
        Vector3 _point;
